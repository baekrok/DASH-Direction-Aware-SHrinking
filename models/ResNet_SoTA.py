...
"""
# We use official pytorch code in SoTA setting to maximize test performance when cold-starting.
...
def resnet18_sota(args):
    """ return a ResNet 18 object
    """
    if 'cifar10' == args.dataset:
        return ResNet(args, BasicBlock, [2, 2, 2, 2], 10)
    elif 'imagenet' == args.dataset:
        return ResNet(args, BasicBlock, [2, 2, 2, 2], 200)
    elif 'cifar100' == args.dataset:
        return ResNet(args, BasicBlock, [2, 2, 2, 2], 100)
