...
def run(args):
    ...
    for chunk_idx in range(args.num_chunks):
        ...
        # Train
        train_acc, train_loss, step = train_chunk(args, model, init_model, criterion, optimizer, schedulers, chunk_loader, chunk_idx)
...
def train_chunk(args, model, init_model, criterion, optimizer, schedulers, chunk_loader, chunk_idx):
    model.train()
    ...
    while True:
        ...
        epoch_acc, epoch_loss = train_epoch(args, model, init_model, criterion, optimizer, scheduler[1], chunk_loader, epoch)
